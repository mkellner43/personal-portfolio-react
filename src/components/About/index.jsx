...
return (
  <motion.section className='about-container'  animate={navIsOpen ? open : closed} initial={false}>
    <motion.h1 initial={{y: -100, opacity: 0}} animate={{y: 0, opacity: 1,transition: {duration: 1}}}>About me.</motion.h1>
    ...
    <motion.p initial={{opacity: 0}} whileInView={{opacity: 1, transition: {duration: 1}}} viewport={{ once: true, amount: 0.2 }}>
