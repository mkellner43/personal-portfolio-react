...
return (
  <motion.section className='about-container'  animate={navIsOpen ? open : closed} initial={false}>
    <div className="flex">
      ...
      Hi, I'm Matt, a full stack web developer with 2 years of experience building websites. Much of my growth came through my undying curiousity for how technology works.
      I enjoy challenging myself to learn new techologies to improve my skillset. Lifetime learning and continuous growth is my passion!
      </motion.p>
